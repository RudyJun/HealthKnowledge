            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 1:
                        ...
                        break;
                    case 2:
                        CommonUtil.showToast(HealthApplication.getApplication(), Constants.NETWORK_ERROR);
                        break;
                    case 3:
                        CommonUtil.showToast(HealthApplication.getApplication(), Constants.NO_NETWORK);
                        break;
                }
