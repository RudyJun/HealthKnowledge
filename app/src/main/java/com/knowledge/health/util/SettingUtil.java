...
public class SettingUtil {
    private static Context context = HealthApplication.getApplication().getApplicationContext();
    ...
    public static SharedPreferences getSettingSharedPreferences() {
        return HealthApplication.getApplication().getSharedPreferences(Constants.APPLICATION_SETTING + Constants.UNDERLINE + getVersion(),
